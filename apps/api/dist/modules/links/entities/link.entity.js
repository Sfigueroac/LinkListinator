...
__decorate([
    (0, typeorm_1.ManyToOne)(() => collection_entity_1.Collection, (c) => c.links, { onDelete: 'CASCADE' }),
    __metadata("design:type", collection_entity_1.Collection)
], Link.prototype, "collection", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], Link.prototype, "collectionId", void 0);
__decorate([
    (0, typeorm_1.ManyToMany)(() => tag_entity_1.Tag, (t) => t.links, { cascade: true, eager: true }),
    (0, typeorm_1.JoinTable)({ name: 'link_tags' }),
